...
fun PlayerStatsJSON.toSteamStatsEntity(): SteamStatsEntity {
    ...
    return SteamStatsEntity(
        ...
        total_deaths = stats?.get(1)?.value,
        total_time_played = stats?.get(2)?.value,
        total_planted_bombs = stats?.get(3)?.value,
        total_defused_bombs = stats?.get(4)?.value,
        total_wins = stats?.get(5)?.value,
        total_damage_done = stats?.get(6)?.value,
        total_money_earned = stats?.get(7)?.value,
        total_rescued_hostages = stats?.get(8)?.value,
        total_kills_knife = stats?.get(9)?.value,
        total_kills_hegrenade = stats?.get(10)?.value,
        total_kills_glock = stats?.get(11)?.value,
        total_kills_deagle = stats?.get(12)?.value,
        total_kills_elite = stats?.get(13)?.value,
        total_kills_fiveseven = stats?.get(14)?.value,
        total_kills_xm1014 = stats?.get(15)?.value,
        total_kills_mac10 = stats?.get(16)?.value,
        total_kills_ump45 = stats?.get(17)?.value,
